...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (cartIcon) {
    cartIcon.addEventListener('click', () => {
      ...
      // Zavře header drawer pokud existuje
      if (headerDrawer && typeof headerDrawer.closeMenuDrawer === 'function') {
        headerDrawer.closeMenuDrawer();
      }

      // Zavře menu drawer fallback
      if (menuDrawer && typeof menuDrawer.closeMenuDrawer === 'function') {
